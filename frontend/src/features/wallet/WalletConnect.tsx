...
import { connectWalletAndSignIn, disconnectWallet, loadSession } from "@/lib/wallet-auth";
...
export function WalletConnect() {
  ...
  async function connect() {
    setPending(true);
    setError(null);
    try { setSession(await connectWalletAndSignIn()); }
  ...
  async function disconnect() {
    setPending(true);
    setError(null);
    try { await disconnectWallet(); setSession(null); }
